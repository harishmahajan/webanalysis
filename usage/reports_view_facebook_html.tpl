        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-hover table-condensed">
                    ...
                    <tr>
                        <td colspan="2">[1]Average from {$AvgContentBreakdown->min_day} to {$AvgContentBreakdown->max_day}</td>
                        <td>[2]{$AvgContentBreakdown->NewEngagement|round}</td>
                        <td>[3]{$AvgContentBreakdown->avg_Post_consumptions|round}</td>
                        <td>[4]{math equation="round( ((( x + y ) / z) * 100) ,1)" x=$AvgContentBreakdown->avg_Post_story_adds y=$AvgContentBreakdown->avg_Post_consumptions z=$AvgContentBreakdown->avg_Post_impressions_unique}%</td>
                        <td>[5]{$AvgContentBreakdown->avg_Post_impressions_unique|round}</td>
                        <td>[6]{$AvgContentBreakdown->avg_Post_impressions|round}</td>
                        <td>[7]{math equation="round( (((x - y) / x) * 100) ,1)" x=$AvgContentBreakdown->avg_Post_impressions_unique y=$AvgContentBreakdown->avg_Post_impressions_fan_unique}%</td>
                    </tr>
                    {/if}
                                ...
                                <table class="table commetrics">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="border-top: none;">{$CommunityMetrics->daily_reach|round:0}</td>
                                        </tr>
                                        <tr>
                                            <td>
