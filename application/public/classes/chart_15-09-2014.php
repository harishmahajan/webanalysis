...
class Chart
{
    ...
    public function CommunityActivity()
    {
        ...
        return $oChart->show('ComboChart',$this->aQuaryArray[2],array('series' => array(array('targetAxisIndex'=>0),array('targetAxisIndex'=>0),array('targetAxisIndex'=>1,'type'=>'bars'))));
    ...
    public function InternalFanSources()
    {
        ...
        $oChart = new \Utility\Phantom_chart(
            ...
            ($this->aQuaryArray[2] == 'img' ? 195 : '230'),
            $aChartData['label'] //array('4/1','4/2','4/3','4/4','4/5','4/6','4/7')
        );
        $oChart->addLinear(
            $aChartData['line1'], //array(3500,4000,3200,5000,4050,4800,4900),
    ...
    public function ReachBreakdown()
    {
        ...
        $oChart = new \Utility\Phantom_chart(
            ($this->aQuaryArray[2] == 'img' ? 260 : '100%'),
            ($this->aQuaryArray[2] == 'img' ? 195 : '300'),
            $aChartData['label'] //array('4/1','4/2','4/3','4/4','4/5','4/6','4/7')
        );
        $oChart->addLinear(
            $aChartData['line1'], //array(3500,4000,3200,5000,4050,4800,4900),
        ...
        */
        ...
        $aoData = \Utility\Db::query("select
            ...
            left join DataFb_PageFansByLikeSource s2 on s2.DataFbID = f.DataFbID and s2.Source in ('api','fan_context_story','feed_chaining','feed_pyml','hovercard',
                ...
                'sponsored_story','ticker','timeline','timeline_collection')
            where
                f.ConnectionID = ? and
                f.`Date` between ? and ?
            group by f.`Date`
        ...
        return $oChart->show('AreaChart',$this->aQuaryArray[2],array('pointSize' => 0));
    ...
    public function RecentCommunityGrowth()
    {
        ...
        return $oChart->show('ComboChart',$this->aQuaryArray[2],array('series' => array(array('targetAxisIndex'=>0),array('targetAxisIndex'=>1,'type'=>'bars'))));
    ...
    public function Followergrowth($iUserId)
    {
        ...
        return $oChart->show('AreaChart',$this->aQuaryArray[2],array('chartArea'=>array('left'=>70)));
    }
}