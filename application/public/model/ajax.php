...
class Ajax extends \Webpage
{
    ...
    public function fb_con_insert()
    {
        $FBcon= new \Model\Facebook();
        echo $FBcon->Conin($_POST['accountID'],$_POST['pageID'],$_POST['accTok']);        
        //$this->TemplateData['data']['content'] = 'in fb_con_insert ajax.php model';
    }
    ...
    public function fb_short_token(){
        ...
        */
        if($oConnection = \Connection::getFacebookConnection($_POST['accountID']))
        {
            ...
            $this->TemplateData['data']['content'] = 'in fb_short_token ajax.php model';
        }

        $this->TemplateData['data']['content'] = 'error in fb_short_token ajax.php model';
    }
    ...
    public function fb_datain(){
        ...
        {
            $this->TemplateData['data']['content'] = 'error in fb_datain ajax.php model';
        }
