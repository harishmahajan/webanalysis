                ...
                foreach($this->aTplVars['oConnections'] as $conn)
                {
                    ...
                    if($conn->Type == 'twitter')
                    {
                        ...
                        $this->aTplVars['connection'][] = array(
                            ...
                            // get new followers
                            'NewFollowers' => \Twitter_data::getNewFollowers($conn->ConnectionID,$oUserData->DataTwUserID,date("Y-m-d",$from_time)),

                            'favorites' => \Twitter_data::getFavorites($conn->ConnectionID,$oUserData->DataTwUserID,date("Y-m-d",$from_time)),
                            'mentions' => \Twitter_data::getMentions($conn->ConnectionID,$oUserData->DataTwUserID,date("Y-m-d",$from_time)),
                            'retweets' => \Twitter_data::getRetweets($conn->ConnectionID,$oUserData->DataTwUserID,date("Y-m-d",$from_time)),
                            'replies' => \Twitter_data::getReplies($conn->ConnectionID,$oUserData->DataTwUserID,date("Y-m-d",$from_time)),
