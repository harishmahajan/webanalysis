...
<nav class="navbar navbar-default" role="navigation" style="margin-top:15px; margin-bottom: 15px;">
    <div class="container-fluid">
            <a class="btn btn-info navbar-btn navbar-right btnPadding" href="/account/pop/{$accountID}" id="btnAddCon">New Connection</a>
    </div>
</nav>
    ...
    <input type="hidden" id="pdf_date_to" name="report_date_to" value="">
                ...
                {if $account_error}
                    <div class="alert alert-warning" id="ErrDiv">
                       ...
                       <strong>Missing Connections:</strong> <lable id="Errolab">{$account_error}</lable>
                       </div>
            ...
            <div id="facebook_select_page" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">                        
                            <input class="form-control" type="hidden" id="fb_date_from" name="fb_date_from" value="{$fb_date_from}">                   
                            <input class="form-control" type="hidden" id="fb_date_to" name="fb_date_to" value="{$fb_date_to}">
                        </div>
...
<br>
<div>
    <a href="/account/delpop/{$accountID}" id="delLink" style="color: red; font-weight: bold; font-size: large; float: right">
        Delete Account
    </a>
</div>
