      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <div class="row">
              ...
              <div class="col-xs-4">
                <a class="btn btn-default" href="/account/pop/{$accountID}" id="btnAddCon">+ Add Connection</a>
              </div>
            </div>            
         </div>
                ...
                <div class="row">
                    <div class="col-md-12 divBG" id="FBbtn">
                        ...
                        {if $oConnections.facebook->ExternalConnectionID}
                            <div id="fb_external_pageidPOP" style="display: none">{$oConnections.facebook->ExternalConnectionID}</div>
                        {/if}
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <input class="form-control" type="hidden" id="fb_date_fromPOP" name="fb_date_fromPOP" value="{$fb_date_from}">                 
                                    <input class="form-control" type="hidden" id="fb_date_toPOP" name="fb_date_toPOP" value="{$fb_date_to}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-9">
...
<form id="backToaccount" method="post" action="/account/connections/{$accountID}">    
</form>
