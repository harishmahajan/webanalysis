...
class Pro
{
    ...
    private function spawn_processor($oConnection) 
    {
        ...
        $op = new ComExe('/usr/bin/php /var/www/application/tw_stream/run_tw_REST.php '.$qs, $oConnection->ConnectionID);
        $this->processors[] = $op;
    }
...
{        
    ...
    private function runCom(){
        $cm = $this->command.' > /var/www/application/tw_stream/tw_User_log/run_tw_REST.'.$this->cid.'.log 2>&1 & echo $!';
        exec($cm,$op);   
    }
}
$objPro= new Pro();